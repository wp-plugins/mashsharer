...
/*
 * Show big read colored update information below the official update notification in /wp-admin/plugins
 * @since 2.0.8
 * @return void
 * @todo create css file for plugins.php with "mashsb_plugin_upgrade_notice{ 10px;background-color: #479CCF;color: #FFF;}"
 */
      ...
      if ( ! is_wp_error( $response ) && ! empty( $response['body'] ) ) {
        ...
        if ( preg_match( $regexp, $response['body'], $matches ) ) {
          ...
          if ( version_compare( WC_VERSION, $version, '<' ) ) {
            ...
            $upgrade_notice .= '<div class="mashsb_plugin_upgrade_notice">';
