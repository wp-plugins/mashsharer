	...
	$mashsb_settings = array(
		...
		'general' => apply_filters( 'mashsb_settings_general',
			...
			array(
					...
					'desc' => __( 'Choose where you would like the social icons to appear, before or after the main content. If set to Manual, you can use this code to place your Social links anywhere you like in your templates files: <strong>&lt;?php do_shortcode("[mashshare]"); ?&gt;</strong> or use the shortcode: [mashshare] in your posts. Optional: <strong>[mashshare shares="false"]</strong> if you like to disable the share number. See all <a href="https://www.mashshare.net/faq/#Is_there_a_shortcode_for_pages_and_posts" target="_blank">possible shortcodes</a> here.', 'mashsb' ),
					'type' => 'select',
                                        'options' => array(
