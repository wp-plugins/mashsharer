...
function mashsb_admin_rate_us( $footer_text ) {
	...
	if ( $typenow == 'download' ) {
		$rate_text = sprintf( __( 'Thank you for using <a href="%1$s" target="_blank">Mashshare Like After Share</a>! Please <a href="%2$s" target="_blank">rate us</a> on <a href="%2$s" target="_blank">WordPress.org</a>', 'mashsb' ),
