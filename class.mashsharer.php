...
<a class="facebook" onclick="javascript:mashFbSharrer(\'' . $url . '\',\'' . esc_html($title) . '\', \'Facebook share popup\',\'http://goo.gl/dS52U\',520,350)" href="javascript:return(0);">Share on Facebook</a>
<a class="twitter" onclick="javascript:mashTwSharrer(\'' . $url . '\', \'' . urlencode(html_entity_decode(get_the_title())) . $hashtag . '\', \'Twitter share popup\', \'http://goo.gl/dS52U\', 520, 350)" href="javascript:return(0)">Tweet on Twitter</a>
                    </div>'
                    . $addons .
                    '</div>
